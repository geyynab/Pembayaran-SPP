...
<html>
  ...
  <style>
    ...
    <body>
        ...
        <?php
        include "koneksi.php";
        $qry_siswa=mysqli_query($conn, "SELECT * FROM siswa JOIN kelas ON siswa.id_kelas=kelas.id_kelas WHERE nisn=" .$_SESSION['nisn']);
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $qry_laporan=mysqli_query($conn, "SELECT * FROM pembayaran WHERE nisn=" .$_SESSION['nisn']);
                $no=0;
