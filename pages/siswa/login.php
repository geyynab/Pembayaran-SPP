            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action= "proses_login.php" method="post" class="form">
                <div class="form-group">
                  <input type="text" name="nama" class="form-control form-control-lg" placeholder="Nama Siswa">
                </div>
                <div class="form-group">
                  <input type="text" name="nisn" class="form-control form-control-lg"  placeholder="NISN">
                </div>
                <div class="mt-3">
