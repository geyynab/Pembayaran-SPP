              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        while($dt_spp=mysqli_fetch_array($qry_spp)){
                            ...
                            <tr>
                                ...
                                <td><a href="ubah_spp.php?id_spp=<?=$dt_spp['id_spp']?>" class="btn btn-success btn-sm">Ubah</a> 
                                | <a href="hapus_spp.php?id_spp=<?=$dt_spp['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger btn-sm">Hapus</a></td>
                            </tr>
                            <?php } ?>
                            <?php
                            ?>
                    ...
                    <br><td><a href="tambah_spp.php" class="btn btn-outline-primary">Tambah SPP</a>
                  </div>
                </div>
              </div>
            </div>
