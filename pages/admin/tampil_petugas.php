                      ...
                      <tbody>
                        ...
                        while($data_petugas=mysqli_fetch_array($qry_petugas)){
                            ...
                            <tr>
                                ...
                                <td><a href="ubah_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" class="badge badge-success">Ubah</a>
                                | <a href="hapus_petugas.php?id_petugas=<?=$data_petugasp['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="badge badge-danger">Hapus</a></td>
                            </tr>
                            <?php } ?>
                            <?php
                            ?>
