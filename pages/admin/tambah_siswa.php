                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <select name="id_kelas" class="form-control">
                        <option value="not_option">Pilih Kelas dan kompetensi Keahlian</option>
                    ...
                    <div class="form-group">
                      <label>Tahun Masuk dan Angkatan</label>
                      <select name="id_spp" class="form-control">
                        <option value="not_option">Pilih Tahun Masuk dan Angkatan</option>
                        <?php include "koneksi.php";
                        $qry_tahun= mysqli_query($conn, "SELECT * FROM spp ORDER BY tahun ASC");
                        while($dt_tahun=mysqli_fetch_assoc($qry_tahun)){
                            echo '<option value="'.$dt_tahun['id_spp'].'">'.$dt_tahun['tahun']. " | " .$dt_tahun['angkatan'].'</option>'; 
                        }
                        ?>
                        </select>
                    </div>
