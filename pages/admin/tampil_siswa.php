              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <thead>
                <tr>
                    <th>NO</th><th>NISN</th><th>NIS</th><th>NAMA</th><th>KELAS</th><th>ALAMAT</th><th>NO. TELP</th><th>ID SPP</th><th>AKSI</th>
                </tr>
            </thead>
            <tbody>
                <?php
                include "koneksi.php";
                $qry_siswa=mysqli_query($conn,"SELECT * FROM siswa, kelas, spp WHERE siswa.id_kelas=kelas.id_kelas AND siswa.id_spp=spp.id_spp ORDER BY nisn ASC");
                $no=0; 
                while($data_siswa=mysqli_fetch_array($qry_siswa)){
                    ...
                    <tr>
                        ...
                        <td><a href="ubah_siswa.php?nisn=<?=$data_siswa['nisn']?>" class="badge badge-success">Ubah</a> 
                        | <a href="hapus_siswa.php?nisn=<?=$data_siswa['nisn']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="badge badge-danger">Hapus</a></td>
                    </tr>
                    <?php } ?>
                    <?php
                    ?>
