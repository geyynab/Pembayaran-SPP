              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        while($data_petugas=mysqli_fetch_array($qry_petugas)){
                            ...
                            <tr>
                                ...
                                <td><a href="ubah_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" class="btn btn-success btn-sm">Ubah</a>
                                | <a href="hapus_petugas.php?id_petugas=<?=$data_petugasp['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger btn-sm">Hapus</a></td>
                            </tr>
                            <?php } ?>
                            <?php
                            ?>
                    ...
                    <br><td><a href="tambah_petugas.php" class="btn btn-outline-primary">Tambah Petugas</a>
